...
<div class="container col-md-5">
	<div class="card">
		<div class="card-body">
			<form:form method="post" action="Guardar Profesional">
				<caption>
				...
				<fieldset class="form-group">
					<label>RUT</label>
					<form:input path="pr_rut" class="form-control" required="required" />
				</fieldset>
				<fieldset class="form-group">
					<label>Nombres</label>
				...
				<input type="submit"  class="btn btn-success" value="Guardar Profesional" />
